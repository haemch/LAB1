...
public class ServiceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Service_time_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Service_time_feature", "_UI_Service_type"),
						StlPackage.Literals.SERVICE__TIME, true, false, false,
	...
	protected void addCostsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Service_costs_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Service_costs_feature",
								"_UI_Service_type"),
						StlPackage.Literals.SERVICE__COSTS, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addNamedParametersPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Service_namedParameters_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Service_namedParameters_feature",
								"_UI_Service_type"),
						StlPackage.Literals.SERVICE__NAMED_PARAMETERS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
