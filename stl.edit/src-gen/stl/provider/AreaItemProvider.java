...
public class AreaItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addConnectorsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Area_connectors_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Area_connectors_feature", "_UI_Area_type"),
						StlPackage.Literals.AREA__CONNECTORS, true, false, true, null, null, null));
	}
