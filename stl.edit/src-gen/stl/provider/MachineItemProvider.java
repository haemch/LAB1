 ...
 * @generated
 */
public class MachineItemProvider extends ComponentsItemProvider {
	/**
	...
	protected void addInputslotPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Machine_inputslot_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Machine_inputslot_feature",
								"_UI_Machine_type"),
						StlPackage.Literals.MACHINE__INPUTSLOT, true, false, true, null, null, null));
	}
	...
	protected void addOutputslotPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Machine_outputslot_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Machine_outputslot_feature",
								"_UI_Machine_type"),
						StlPackage.Literals.MACHINE__OUTPUTSLOT, true, false, true, null, null, null));
	}
